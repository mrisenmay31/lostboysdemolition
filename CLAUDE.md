...
bare bones first, manual actuals acceptable, automate later. v2 Task 8b is **paused** pending
three rulings recorded in that doc (8b shape — proposed: an owner-side "Mark started / Mark
completed" action instead of the foreman area; who enters actuals; how quotes reach customers).
