...
- [~] **Step 4 (orchestrator):** Committed and pushed: `d72878c` (4b), `51ad5fb` (4c + deno.json grant), `7028b63` (4a, post-GREEN per runbook step 6). **PENDING MATT:** prod apply of the migration; `ghl-job-webhook` deploy via the two-command invariant + readback (flag left UNSET); live re-drag probe on JOB-1104 + re-cancel.
